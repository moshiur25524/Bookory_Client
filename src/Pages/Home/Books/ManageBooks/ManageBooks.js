          ...
          <div className="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            ...
            <div className="p-3">
              <div className="overflow-x-auto">
                        ...
                        <td className="p-2 whitespace-nowrap">
                          <div className="text-lg text-center">
                            <button
                              ...
                              className="inline-block px-6 py-2.5 bg-transparent text-red-600 font-medium text-xs leading-tight uppercase rounded focus:outline-none  active:text-blue-800 transition duration-300 ease-in-out"
                            >
                              Delete
                            </button>
                          </div>
                ...
                <Link
                  className="block mx-auto text-center px-7 py-3 bg-transparent text-blue-600 font-medium text-sm leading-snug uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out"
